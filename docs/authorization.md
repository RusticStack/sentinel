...
- Human users are global to the deployment. Service principals have an immutable home tenant, cannot be super admins, cannot have external sign-in identities and cannot acquire tenant-admin memberships. Their tokens will carry explicit expiry/scopes in A03; a stored account alone authenticates nobody.
