...
| `crates/sentinel-auth` | Password hashing, opaque session/credential secrets, cookie/CSRF policy; see [local authentication](docs/local-authentication.md) and [API credentials](docs/api-credentials.md) |
