...
**Next task:** `C01` — define stable tenant/repo/run/job/step/attempt/worker IDs and the run/job state machine (terminal aggregation, transition permissions, timestamps, failure classes, cancellation desired state), then `C02` SQLite migrations using the F07 writer decision.
