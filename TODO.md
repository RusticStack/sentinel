...
**Next task:** `C03` — versioned API errors, idempotency keys, event sequence/cursors, protocol size limits, worker capability negotiation and supported-version mismatch behaviour, then `C04` strict `.sentinel.yml` parsing.
